...
export const SIGNAL_CATALOG: SignalCatalogEntry[] = [
  ...
  { kind: 'of_delta', label: 'Orderflow Delta (buy vol - sell vol, crypto only, Pro)', category: 'Volume / Order-Flow Proxy', isBoolean: false, params: [] },
  { kind: 'of_cvd', label: 'Cumulative Volume Delta (CVD, crypto only, Pro)', category: 'Volume / Order-Flow Proxy', isBoolean: false, params: [] },
  { kind: 'of_buy_ratio', label: 'Buy Volume Ratio (0-1, crypto only, Pro)', category: 'Volume / Order-Flow Proxy', isBoolean: false, params: [] },
  { kind: 'of_delta_divergence_bullish', label: 'Delta Divergence - bullish (crypto only, Pro)', category: 'Volume / Order-Flow Proxy', isBoolean: true, params: [{ key: 'swingLookback', label: 'Swing lookback', default: 2 }] },
  { kind: 'of_delta_divergence_bearish', label: 'Delta Divergence - bearish (crypto only, Pro)', category: 'Volume / Order-Flow Proxy', isBoolean: true, params: [{ key: 'swingLookback', label: 'Swing lookback', default: 2 }] },
  { kind: 'of_cvd_rising', label: 'CVD Rising - net up over N bars (crypto only, Pro)', category: 'Volume / Order-Flow Proxy', isBoolean: true, params: [{ key: 'lookback', label: 'Lookback (bars)', default: 5 }] },
  { kind: 'of_cvd_falling', label: 'CVD Falling - net down over N bars (crypto only, Pro)', category: 'Volume / Order-Flow Proxy', isBoolean: true, params: [{ key: 'lookback', label: 'Lookback (bars)', default: 5 }] },
