...
export default function DashboardPage() {
  ...
  return (
    <main className="min-h-screen max-w-6xl mx-auto px-6 py-8 space-y-6">
      ...
      <StrategyBuilder onResult={(r, b, s) => { setResult(r); setBars(b); setSymbol(s); }} />
      {result && (
        <div className="space-y-4">
          <div className="card p-4"><h2 className="font-semibold mb-3">{symbol} — price &amp; trade markers</h2><PriceChart bars={bars} trades={result.trades} /></div>
          <div className="card p-4"><h2 className="font-semibold mb-3">Equity curve</h2><EquityChart equityCurve={result.equityCurve} /></div>
